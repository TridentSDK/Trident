...
public class PacketPlayInClientSettings extends InPacket {
    ...
    /**
     * Chat settings:  Bits 0-1. 00: Enabled. 01: Commands only. 10: Hidden.
     */
    ...
    /**
     * Displayed skin parts also packs several values into one byte.  Bit 0: Cape enabled Bit 1: Jacket enabled Bit
