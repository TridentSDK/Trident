...
public final class PacketRegistry {
    ...
    static {
        ...
        put(PlayOutPlayerAbilities.class, NetClient.NetState.PLAY, Packet.Bound.CLIENT, 0x2C);
        put(PlayOutTabListItem.class, NetClient.NetState.PLAY, Packet.Bound.CLIENT, 0x2E);
        put(PlayOutPosLook.class, NetClient.NetState.PLAY, Packet.Bound.CLIENT, 0x2F);
        put(PlayOutDestroyEntities.class, NetClient.NetState.PLAY, Packet.Bound.CLIENT, 0x32);
        put(PlayOutEntityHeadLook.class, NetClient.NetState.PLAY, Packet.Bound.CLIENT, 0x36);
        put(PlayOutWorldBorder.class, NetClient.NetState.PLAY, Packet.Bound.CLIENT, 0x38);
        put(PlayOutEntityMetadata.class, NetClient.NetState.PLAY, Packet.Bound.CLIENT, 0x3C);
        put(PlayOutEquipment.class, NetClient.NetState.PLAY, Packet.Bound.CLIENT, 0x3F);
        put(PlayOutSpawnPos.class, NetClient.NetState.PLAY, Packet.Bound.CLIENT, 0x46);
        put(PlayOutTime.class, NetClient.NetState.PLAY, Packet.Bound.CLIENT, 0x47);
        put(PlayOutTitle.class, NetClient.NetState.PLAY, Packet.Bound.CLIENT, 0x48);
        put(PlayOutPlayerListHeaderAndFooter.class, NetClient.NetState.PLAY, Packet.Bound.CLIENT, 0x4A);
        put(PlayOutTeleport.class, NetClient.NetState.PLAY, Packet.Bound.CLIENT, 0x4C);

        put(PlayInTeleportConfirm.class, NetClient.NetState.PLAY, Packet.Bound.SERVER, 0x00);
        put(PlayInChat.class, NetClient.NetState.PLAY, Packet.Bound.SERVER, 0x02);
        put(PlayInClientStatus.class, NetClient.NetState.PLAY, Packet.Bound.SERVER, 0x03);
        put(PlayInClientSettings.class, NetClient.NetState.PLAY, Packet.Bound.SERVER, 0x04);
        put(PlayInCloseWindow.class, NetClient.NetState.PLAY, Packet.Bound.SERVER, 0x08);
        put(PlayInPluginMsg.class, NetClient.NetState.PLAY, Packet.Bound.SERVER, 0x09);
        put(PlayInUseEntity.class, NetClient.NetState.PLAY, Packet.Bound.SERVER, 0x0A);
        put(PlayInKeepAlive.class, NetClient.NetState.PLAY, Packet.Bound.SERVER, 0x0B);
        put(PlayInPlayer.class, NetClient.NetState.PLAY, Packet.Bound.SERVER, 0x0C);
        put(PlayInPos.class, NetClient.NetState.PLAY, Packet.Bound.SERVER, 0x0D);
        put(PlayInPosLook.class, NetClient.NetState.PLAY, Packet.Bound.SERVER, 0x0E);
        put(PlayInLook.class, NetClient.NetState.PLAY, Packet.Bound.SERVER, 0x0F);
