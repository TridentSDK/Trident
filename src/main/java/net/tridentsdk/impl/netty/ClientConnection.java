 ...
 */
package net.tridentsdk.impl.netty;
...
public class ClientConnection {
    ...
    /**
     * The secret key shared between the client and impl
     */
    ...
    /**
     * Checks if an IP address is logged into the impl
     *
     * @param address the address to check if online
     * @return {@code true} if the IP is on the impl, {@code false} if not
     */
     ...
     *
     * @return the {@link javax.crypto.SecretKey} shared between the impl and client
     */
    ...
    /**
     * Removes the client's impl side client handler
     */
    public void logout() {
